...
class Clientes extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  Clientes(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> deletedAt = GeneratedColumn<String>(
    'deleted_at',
    aliasedName,
    true,
  ...
  @override
  Clientes createAlias(String alias) {
    return Clientes(attachedDatabase, alias);
  }
...
class MovimientosCliente extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  MovimientosCliente(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
    'id',
    aliasedName,
    false,
  ...
  late final GeneratedColumn<String> clienteId = GeneratedColumn<String>(
    ...
    type: DriftSqlType.string,
    requiredDuringInsert: true,
    $customConstraints: 'NOT NULL REFERENCES clientes(id)',
  );
  late final GeneratedColumn<String> tipo = GeneratedColumn<String>(
    'tipo',
    aliasedName,
  ...
  late final GeneratedColumn<String> ventaId = GeneratedColumn<String>(
    ...
    type: DriftSqlType.string,
    requiredDuringInsert: false,
    $customConstraints: 'NULL REFERENCES ventas(id)',
  );
  ...
  @override
  MovimientosCliente createAlias(String alias) {
    return MovimientosCliente(attachedDatabase, alias);
  }
...
class DatabaseAtV3 extends GeneratedDatabase {
  ...
  late final Clientes clientes = Clientes(this);
  late final MovimientosCliente movimientosCliente = MovimientosCliente(this);
